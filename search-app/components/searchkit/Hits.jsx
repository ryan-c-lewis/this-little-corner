        ...
        <EuiFlexItem>
          <EuiFlexGroup>
            <EuiFlexItem grow={4}>
              ...
              <EuiFlexGroup>
                <EuiFlexItem grow={4}>
                  <iframe id={"video_" + hit.fields.id} width="560" height="315" src={"https://www.youtube.com/embed/" + hit.fields.id + "?enablejsapi=1"}
                ...
                <EuiFlexItem grow={4}>
                  <div style={{'maxHeight': 315, 'overflowY': 'auto'}}>
                    ...
                    {hit.fields.transcript_parts.map((part) => (
                        <a href={"javascript:jump('video_" + hit.fields.id + "', " + part.start + ");"} key={part.start}><span>{part.text} </span></a>
                    ))}
                  </div>
                </EuiFlexItem>
              </EuiFlexGroup>
